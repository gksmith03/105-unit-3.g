...
In this repository you will find the data from WONDER's database that has already been adapted, but users may follow the steps laid out in the (______) in order to adapt more sets provided by WONDER to a more concise formatting. 
